...
@pytest.mark.asyncio
async def test_read_user_profile_success(async_client):
    # 사용자 생성
    register_data = {
        "username": "profile_test_user",
        "nickname": "profile_test_nickname",
    ...
    assert user_profile['username'] == "profile_test_user"
    assert user_profile['nickname'] == "profile_test_nickname"
